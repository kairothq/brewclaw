    ...
    >
      <div className="max-w-4xl mx-auto text-center">
        ...
        <motion.div
          ...
          className="text-6xl md:text-8xl font-heading font-bold text-zinc-900"
        >
        ...
        <motion.p
          ...
          className="text-zinc-600 mt-4 mb-10"
        >
        ...
        <motion.div
          ...
          className="bg-white rounded-2xl p-6 shadow-sm border border-zinc-200 max-w-md mx-auto"
        >
          {/* Batch header */}
